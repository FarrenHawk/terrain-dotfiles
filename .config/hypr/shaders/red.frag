...
void main() {
  ...
  pixColor[0] = mono;
  // green
  pixColor[1] = mono - 1.0; //0.2126
  // blue
  pixColor[2] = mono - 1.0; //0.2126

  gl_FragColor = pixColor;
}

//Thank you so much u/otterlord-dev at https://gist.github.com/TheOtterlord/f95ffc737761e9a91c031336197df158 !!!!!
